...
?>
	...
	<form name="contactform" method="post" > <!-- action="send_form_email.php"-->
		<div align="center" style="float: right; margin:50px; " class="form-group" >
		<!-- <textarea name="delete" placeholder="Enter Bug Here" class="form-control" rows="10" id="comment"></textarea> -->
		<button name="delete" type="submit" value="1" style="width:150px; height=50px;">Delete</button>
		</div>
	</form>
</div>
<?php
